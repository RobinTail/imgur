...
var PlayCircleOutline = require('material-ui/lib/svg-icons/av/play-circle-outline');
...
module.exports = React.createClass({
    ...
    render: function() {
        return <GridTile
                ...
                >
                    {this.props.animated && this.state.hover ? this.renderVideo() : this.renderImage()}
                    {this.props.animated && !this.state.hover ? this.playIcon() : null}
                </GridTile>;
    },
    playIcon: function() {
